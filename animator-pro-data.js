const animatorProProjectImages = [
  ...
  <header class="project-header">
    <span class="project-category">
      Animation Platform • UI/UX Design • Software Development
    </span>
    ...
    <p class="project-summary">
      <strong>ANimator Pro</strong> is a visual animation content creation
      platform designed to help creators produce engaging videos for
      <span>YouTube</span>, <span>Facebook</span>, <span>TikTok</span>, and
      other digital media channels. The platform combines character creation,
      appearance customization, movement configuration, scene management, and
      live visual composition in a single workspace. This showcase demonstrates
      how an animated character can be added to a complex offshore digital twin
      environment and prepared for educational, promotional, storytelling, or
      social media content.
    </p>
  </header>

  <section class="project-section">
    <h2>Character and Scene Creation</h2>

    <p>
      The <strong>Spawn Character</strong> section allows users to select a
      predefined character template and instantly place it inside the active
      scene. This provides a fast starting point for building animated
      presentations without creating every character from the beginning.
      Through the <strong>Add Entities</strong> section, creators can also
      introduce additional characters, objects, props, and supporting visual
      elements required for the animation.
    </p>

    <p>
      The <strong>Active Scene Entities</strong> panel provides centralized
      management of everything currently included in the composition. Users can
      select an entity, change its layer position, control its visibility,
      enable editing, or remove it from the scene. This structured approach is
      especially useful when an animation contains multiple characters and
      interactive elements.
    </p>
  </section>

  <section class="project-section">
    <h2>Appearance and Identity Customization</h2>

    <p>
      ANimator Pro includes a flexible <strong>Modifiers</strong> system for
      personalizing the selected character. Creators can adjust visual details
      such as skin tone, hairstyle, shirt, pants, and shoes. These controls make
      it possible to develop distinctive characters that match a brand,
      narrative, audience, or campaign style.
    </p>

    <p>
      The <strong>Name &amp; Bubble</strong> section controls the character's
      displayed name and communication content. Users can add speech or thought
      messages to support conversations, explanations, reactions, and
      storytelling. This feature is valuable for animated tutorials, product
      presentations, educational videos, short-form social content, and
      character-led demonstrations.
    </p>
  </section>

  <section class="project-section">
    <h2>Movement and Animation Controls</h2>

    <p>
      The <strong>Scale</strong> control resizes a character to match the
      perspective and visual proportions of the selected background. The
      <strong>Speed</strong> setting manages movement velocity and animation
      timing, giving creators greater control over how quickly a character
      travels through the scene.
    </p>

    <p>
      With <strong>Walk Type</strong>, users can select the movement behavior
      that best suits the character and story. The <strong>Hair Type</strong>
      option provides additional hairstyle variations, supporting faster
      character customization without requiring manual illustration or external
      design software.
    </p>
  </section>
  ...
  <section class="project-section">
    ...
    <p>
      The central preview canvas displays the selected background, animated
      characters, and supporting elements as one live visual composition. In
      this example, the background presents an offshore oil and gas digital twin
      containing an FPSO vessel, subsea pipelines, production infrastructure,
      environmental information, operational statistics, and real-time
      monitoring panels.
    </p>

    <p>
      A cartoon character is layered over the technical environment,
      demonstrating how ANimator Pro can transform complex industrial visuals
      into approachable animated content. This combination can be used for
      technical explainers, safety training, digital twin presentations,
      corporate communication, educational storytelling, and social media
      campaigns.
    </p>
  </section>
  ...
  <footer class="project-footer">
    ...
    <p>
      ANimator Pro brings character design, movement controls, scene
      composition, and content preparation into one streamlined application.
      Its visual interface helps creators build scenes faster, customize
      characters easily, preview compositions immediately, and prepare polished
      animation content for publication across multiple platforms.
    </p>
  </footer>
</article>
        `
